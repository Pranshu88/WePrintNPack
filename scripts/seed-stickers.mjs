 ...
 *
 * Gallery 1: Die-Cut Stickers  (3 designs — unchanged)
 * Gallery 2: Product Labels    (14 designs — circle, oval, rectangle, square)
 */
...
// ═══════════════════════════════════════════════════════════════════════════════
//  DIE-CUT STICKER LAYOUTS  (unchanged)
// ═══════════════════════════════════════════════════════════════════════════════

function stickerRoundBadge(p, a) {
...
function stickerShieldShape(p, a) {
...
// ═══════════════════════════════════════════════════════════════════════════════
//  PRODUCT LABEL — RECTANGLE designs
// ═══════════════════════════════════════════════════════════════════════════════
...
const STICKER_TEMPLATES = [
  {
    galleryName: "Die-Cut Stickers",
    designs: [
      {
        name: "Round Badge",
        fn: stickerRoundBadge, p: "#1e3a5f", a: "#06b6d4", bg: "#f8fafc",
        colors: [
      ...
      {
        name: "Shield Shape",
        fn: stickerShieldShape, p: "#1d4ed8", a: "#fbbf24", bg: "#f8fafc",
        colors: [
      ...
      {
        name: "Hexagon",
        fn: stickerHexagon, p: "#0d9488", a: "#fbbf24", bg: "#f8fafc",
        colors: [
...

  {
    ...
    designs: [
      // ── Circle ──────────────────────────────────────────────────────────────
      {
        ...
        colors: [
          { name: "Warm Brown", p: "#c8832a", a: "#c8832a" },
      ...
      },
      {
        ...
        colors: [
          { name: "Coral",     p: "#e8736a", a: "#e8736a" },
          { name: "Teal",      p: "#0d9488", a: "#0d9488" },
          { name: "Purple",    p: "#7c3aed", a: "#7c3aed" },
          { name: "Navy",      p: "#1e3a5f", a: "#1e3a5f" },
        ],
      },
      {
      ...
      },
      {
        ...
        colors: [
          { name: "Gold",      p: "#d4af37", a: "#d4af37" },
          { name: "Rose Gold", p: "#c09070", a: "#c09070" },
          { name: "Silver",    p: "#9ca3af", a: "#9ca3af" },
          { name: "Bronze",    p: "#8b6914", a: "#8b6914" },
        ],
      },
      {
        name: "Vintage Event",
      ...
      // ── Oval ────────────────────────────────────────────────────────────────
      {
        ...
        colors: [
          { name: "Multicolor", p: "#ec4899", a: "#ec4899" },
        ],
      },
      {
        name: "Clean Oval",
      ...
      // ── Rectangle ───────────────────────────────────────────────────────────
      {
        ...
        colors: [
          { name: "Burgundy",  p: "#8b1a2a", a: "#8b1a2a" },
          { name: "Navy",      p: "#1e3a5f", a: "#1e3a5f" },
          { name: "Forest",    p: "#14532d", a: "#14532d" },
          { name: "Charcoal",  p: "#374151", a: "#374151" },
        ],
      },
      {
        ...
        colors: [
          { name: "Navy Dark",   p: "#0f172a", a: "#0f172a" },
          { name: "Forest Dark", p: "#0a3622", a: "#0a3622" },
          { name: "Charcoal",    p: "#1f2937", a: "#1f2937" },
          { name: "Burgundy",    p: "#3b0b0b", a: "#3b0b0b" },
        ],
      },
      {
        name: "Vintage Badge",
      ...
      },
      {
        ...
        colors: [
          { name: "Dark Blue",  p: "#1a1f2e", a: "#1a1f2e" },
          { name: "Charcoal",   p: "#1f2937", a: "#1f2937" },
          { name: "Navy",       p: "#1e3a5f", a: "#1e3a5f" },
          { name: "Forest",     p: "#0a3622", a: "#0a3622" },
        ],
      },
      // ── Square ──────────────────────────────────────────────────────────────
      {
