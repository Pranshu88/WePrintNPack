...
export function AdminApparelPage() {
      ...
      <div style={S.mainArea}>
        ...
        <main style={S.content}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 24 }}>
            <div>
              ...
              <h1 style={{ margin: "0 0 6px", fontSize: "2rem", fontWeight: 800, color: "#111827" }}>
                Apparel <span style={{ color: "#7c3aed" }}>Templates</span>
              </h1>
              ...
              <p style={{ margin: 0, fontSize: "0.9rem", color: "#6b7280" }}>
                Manage gallery templates and design options for T-Shirts.
              </p>
            </div>
          </div>
          ...
          {loading ? (
            ...
            <AdminTemplateSection products={products} openAddRef={openAddRef} onlyCategory="t-shirts" />
          )}
        </main>
      </div>
